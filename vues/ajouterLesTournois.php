...
?>
	...
	<div class="panel-heading">Ajout des Tournois</div>
	<div class="panel-body">
	
	<form class="form-horizontal" role="form" method="post" action="">
			<div class="form-group"><label class="control-label col-sm-2">Nom du Tournois : </label>
				<div class="col-sm-10">
					<input class="form-control" type="text" name="nomtournois"  />
		...
		?>
			...
			<div class="form-group"><label class="control-label col-sm-2">Date Debut du Tournois : </label>
				<div class="col-sm-10">
					<input class="form-control" type="date" name="datedebuttournois" />
				</div>
			</div>	
			<div class="form-group"><label class="control-label col-sm-2">Date Fin du Tournois : </label>
				<div class="col-sm-10">
					<input class="form-control" type="date" name="datefintournois"  />
				</div>	
			</div>
